...
class module extends Module_Base {
	...
	public function widget_before_render_content( $widget_content, $widget ) {
		...
		if ( ! empty( $settings['jupiter_widget_tooltip_description'] ) ) {
			echo sprintf( '<div id="jupiter-tooltip-content-%1$s" class="jupiter-tooltip-widget__content">%2$s</div>', $data['id'], $settings['jupiter_widget_tooltip_description'] );
		}
