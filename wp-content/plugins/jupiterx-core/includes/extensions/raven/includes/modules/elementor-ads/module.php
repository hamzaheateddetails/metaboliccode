...
class Module extends Module_Base {
	...
	private function actions() {
		...
		add_action( 'admin_menu', [ $this, 'remove_elementor_pro_related_menu_items' ], 0 );
	 ...
	 * @since 2.5.0
	 */
	public function remove_elementor_pro_related_menu_items() {
		remove_action( 'admin_menu', [ Plugin::$instance->settings, 'register_pro_menu' ], Plugin::$instance->settings::MENU_PRIORITY_GO_PRO );
	}
