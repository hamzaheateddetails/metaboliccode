		...
		<div class="pop_up_sub_wrap">
			...
			<div class="hubwoo_pop_up_wrap--image">
				<div class="hubwoo_pop_up_wrap--image--inner-content">
					...
					<p>
						<?php esc_html_e( 'MakeWebBetter is a HubSpot Diamond Solutions Partner. Schedule a meeting with our experts to learn more about HubSpot.', 'hubspot-for-woocommerce' ); ?>
					</p>
