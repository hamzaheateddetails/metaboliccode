...
class Basic_Menu extends Widget_Base {
	...
	protected function render() {
		...
		echo "<div class='woolementor-basic-menu-wrapper {$class}'>";
		...
		<div <?php echo $this->get_render_attribute_string( 'menu-toggle' ); ?>>
			...
			<nav class="woolementor-nav-menu--dropdown woolementor-nav-menu__container" role="navigation" aria-hidden="true"><?php echo $dropdown_menu_html; ?></nav>
		<?php
